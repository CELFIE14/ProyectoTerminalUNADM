...
<!--       MODAL DE REGISTRO DE USUARIOS -->
        <section class="modal" id="modal">
            <div class="modal_container">
                <h2 class="tiulo_modal">Registro de usuarios</h2>

                <form action="../Controlador/registro_usuarios.php" class="registroUsuarios" id="form" method="POST">
                <?php
                include "../Modelo/conexion.php";

                ?>
                    <label for="">Nombre de usuario:</label>
                    <input class="icamposusuario" type="text" name="nombre" id="nombre" value="" pattern="[a-zA-Z[:space:]]{3,50}" maxlength="50" required>
                    <label for="">Area:</label>
                    <select name="catArea" id="catArea" class="icamposusuario" required>
                    ...
                    <label for="">Rol:</label>
                    <select name="catRol" id="catRol" class="icamposusuario" required>
                    ...
                    <input class="icamposusuario" type="email" name="correo" id="correo" value="" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}" required><br>
                    <label for="">Contraseña:</label>
                    <input class="icamposusuario" type="password" name="password" id="password" value="" pattern="[a-zA-Z0-9$@-]{8,20}" required><br>
                    <input class="btnGuardar" id= "btnModalguardar" type="submit" name="btnGuardar" value="Guardar">
