...
<body>
    <section class="alertEliminar" id="alertEliminar">
            <div class="alert_container_eliminar">
                ...
                <form action="../Controlador/eliminar_usuarios.php" class="eliminarRegistro" method="POST">
                        <input type="hidden" name="id" value="<?=$_GET["id"]?>">
                        <input class="btnEliminarRegistro" id= "btnEliminar" type="submit" name="btnEliminar" value="Eliminar">
                        <a href="../Vistas/Mod01Admin.php"><input class="btnCancelar" id= "btnCancelarEliminar" type="button" name="btnCancelarEdicion" value="Cancelar"></a> 
                    <?php
